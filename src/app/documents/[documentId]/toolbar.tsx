...
const HeadingLevelButton = () => {
    ...
    const headings = [
        ...
        { label: "Subtitle", value: 4, fontSize: "18px" },
        { label: "Small Text", value: 5, fontSize: "14px" },
        { label: "Code", value: 6, fontSize: "15px", fontFamily: "Courier New" },
        { label: "Quote", value: 7, fontSize: "16px", fontStyle: "italic" },
        { label: "Title", value: 8, fontSize: "40px", fontWeight: "bold" },
        { label: "Caption", value: 9, fontSize: "13px", color: "#666" }
    ];
